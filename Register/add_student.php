                ...
                <div class="content-wrapper">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6">
                                    <h3 class="col text-left">Add New Student</h3>
                                </div>
...
<div class="card-body px-4 py-5 px-md-5">
    ...
    <div data-mdb-input-init class="form-outline mb-4">
        ...
        <input type="email" id="email_address" name="email_address" class="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" value="<?php echo isset($_POST['email_address']) ? $_POST['email_address']: ""?>" />
    ...
    <!-- Password input -->
        <div data-mdb-input-init class="form-outline mb-4">
            ...
            <input type="password" id="password" name="password" class="form-control" minlength="8" pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}" />
            ...
            <div data-mdb-input-init class="form-outline mb-4">
              ...
              <!-- Submit button -->
              <input type="submit" class="btn btn-primary mb-4" name="login" value="Sign Up">
